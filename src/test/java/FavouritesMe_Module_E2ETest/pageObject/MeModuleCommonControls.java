...
public class MeModuleCommonControls extends WebNavPage{
    ...
    public boolean verifyBenefitsPageContents(String arg1) {
        ...
        return assertIfTwoTextsEqual(array[0],getTextUsingBy(benefitOne)) && assertIfTwoTextsEqual(array[1],getTextUsingBy(benefitTwo)) && assertIfTwoTextsEqual(array[2], getTextUsingBy(benefitThree)) && elementIsVisible(benefitImage);
    }
