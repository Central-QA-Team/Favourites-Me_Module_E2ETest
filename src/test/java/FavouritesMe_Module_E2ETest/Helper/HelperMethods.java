...
public class HelperMethods extends WebNavPage {
    ...
    public static boolean ptrtSetTo(String PTRT) {
        try {
            return (URLDecoder.decode(currentURL(), "UTF-8").contains(("ptrt=" + PTRT).replace("www."+System.getProperty("Env")+".bbc.co.uk",System.getProperty("Env")+".bbc.co.uk")) || URLDecoder.decode(currentURL(), "UTF-8").contains("[ptrt]=" + PTRT));
